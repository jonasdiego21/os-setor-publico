...
public class FornecedoresController {
	...
	@PostMapping
	public ModelAndView cadastrar(@Valid Fornecedor fornecedor, BindingResult result, Model model, RedirectAttributes attributes, @AuthenticationPrincipal Usuario usuario) {
	...
	@GetMapping
	public ModelAndView pesquisar(FornecedorFilter fornecedorFilter, BindingResult result, @PageableDefault(size = 25) Pageable pageable) {
